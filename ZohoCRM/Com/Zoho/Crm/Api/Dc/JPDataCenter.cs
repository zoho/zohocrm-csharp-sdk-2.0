...
namespace Com.Zoho.Crm.API.Dc
{
    ...
    public class JPDataCenter : DataCenter
    {
        ...
        /// </summary>
        public static readonly Environment PRODUCTION = new Environment("jp_prd", "https://www.zohoapis.jp", JP.GetIAMUrl(), JP.GetFileUploadUrl());

        /// <summary>
        /// This Environment class instance represents the Zoho CRM Sandbox Environment in Japan Domain.
        /// </summary>
        public static readonly Environment SANDBOX = new Environment("jp_sdb", "https://sandbox.zohoapis.jp", JP.GetIAMUrl(), JP.GetFileUploadUrl());

        /// <summary>
        /// This Environment class instance represents the Zoho CRM Developer Environment in Japan Domain.
        /// </summary>
        public static readonly Environment DEVELOPER = new Environment("jp_dev", "https://developer.zohoapis.jp", JP.GetIAMUrl(), JP.GetFileUploadUrl());
