...
namespace Com.Zoho.Crm.API.Util
{
    ...
    public static class Constants
    {
        ...
        public static readonly string DATATYPECONVERTER = "Com.Zoho.Crm.API.Util.DataTypeConverter`1[[$type]], ZOHOCRMSDK-2.0";

        public static readonly string CHOICE = "Com.Zoho.Crm.API.Util.Choice`1[[$type]], ZOHOCRMSDK-2.0";
        ...
        public static readonly string RECORD_TYPE = "Com.Zoho.Crm.API.Record.Record, ZOHOCRMSDK-2.0";
